            ...
            <div class="content-area">
                ...
                <div class="profile-section">
                    ...
                    <div class="profcus" id="profcus">
                        <div class="item-01">
                            <form action="{{ route('user.upload') }}" class="profileimgage" method="POST"
                                enctype="multipart/form-data">
                                @csrf
                                <div>
                                    @if (Auth::user()->profile)
                                        <img class="user-image" src="{{ asset('storage/' . Auth::user()->profile) }}"
                                            alt="Profile Picture" id="profile-pic-admin">
                                    @else
                                        <img class="user-image" src="{{ asset('images/user.png') }}"
                                            alt="Profile Picture" id="profile-pic-admin">
                                    @endif
                                </div>
                                ...
                                <div class="insertImg">
                                    ...
                                    <input class="input" type="file" name="profilepic"
                                        accept="image/jpg, image/png, image/jpeg" id="input-file">
