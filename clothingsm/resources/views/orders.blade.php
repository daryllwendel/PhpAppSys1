                ...
                @foreach ($ordersData as $orderItems)
                    ...
                    <div class="order">
                        <div class="hov">
                            ...
                            <p>{{ $orderItems->paymentMethod ?? 'not set'}}</p>
                        </div>
                    </div>
                        ...
                        <div class="main-content-wrapper">
                            <div class="shipping-details2">
                                ...
                                <div class="form-group2">
                                    ...
                                    <input type="text" id="recipient2" name="recipient2" value="{{$orderItems->name}}"
                                        class="form-control2" readonly>
                                </div>

                                <div class="form-group2">
                                    <label for="email2">Email</label>
                                    <input type="email" id="email2" name="email2" value="{{$orderItems->email}}"
                                        class="form-control2" readonly>
                                </div>

                                <div class="form-group2">
                                    <label for="contact2">Contact Number</label>
                                    <input type="text" id="contact2" name="contact2" value="{{$orderItems->contactNo}}"
                                        class="form-control2" readonly>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group2">
                                        ...
                                        <input type="text" id="city2" name="city2" class="form-control2"
                                            value="{{$orderItems->City}}" readonly>
                                    </div>
                                    <div class="form-group2">
                                        <label for="barangay2">Barangay</label>
                                        <input type="text" id="barangay2" name="barangay2" class="form-control2"
                                            value="{{$orderItems->Baranggay}}" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-row">
                                    <div class="form-group2">
                                        ...
                                        <input type="text" id="purok2" name="purok2" class="form-control2"
                                            value="{{$orderItems->Purok}}" readonly>
                                    </div>
                                    <div class="form-group2">
                                        <label for="zipcode2">ZipCode</label>
                                        <input type="text" id="zipcode2" name="zipcode2" value="{{$orderItems->ZipCode}}"
                                ...
                                <div class="form-group2">
                                    ...
                                    <input type="text" id="grand-total2" name="grand_total2"
                                        value="{{$orderItems->totalCharge}}" class="form-control2" readonly>
                                </div>
                            </div>
                            ...
                            <div class="order-summary2">
                                ...
                                <div class="order-total2">
                                    <h4>Sub-Total: ₱ <span id="checkout-subtotal2">{{$orderItems->totalItemPrice}}</span>
                                    </h4>
                                </div>
                            </div>
                        </div>
