  ...
  <div class="checkout-form2" id="checkout-form2" style="display: none">
        <div class="checkout-container-layout2">
            ...
            <div class="main-content-wrapper">
                <div class="shipping-details2">
                    ...
                    <div class="form-group2">
                      ...
                      <div class="form-group"  id="bank-details" style="display: block;">
                        <label for="names">Name:</label>
                        <input type="text" id="name" name="name" class="form-control" value="{{$order->paymentName}}" readonly>
                        <label for="bank-name">Bank Name:</label>
                        <input type="text" id="bank-name" name="bank_name" class="form-control" value="{{$order->bankName}}" readonly>
                        <label for="numbers">Number:</label>
                        <input type="text" id="number" name="number" class="form-control" value="{{$order->accountNumber}}" readonly>
                    </div>
            ...
            <div class="checkout-buttons2">
                <form action="/cancelorder" method="POST" class="cancelorder">
                    @csrf
                    @method('PUT')
                    <button style="submit" class="cancelorder">Cancel</button>
                </form>
        ...
        <div class="checkout-container-layout2">
            ...
            {{-- sa --}}
             <div class="orders-list" id="cancelList" style="display: none;">
